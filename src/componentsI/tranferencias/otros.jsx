...
export default function Otro() {
    ...
    const handleChange = (e) => {
        ...
        else if (name === "banco") setBanco(value);
    ...
    const handleSubmit = () => {
        ...
        const fetchUserData = async () => {
            ...
            if (cuenta === "" || cantidad === "" || selectedCard === "" || nombre===""  || banco=="") {console.log("tengo un basio");
                setCarga(false);
                ...
                setMensaje2('');
                try {
                    const response = await fetch(`http://127.0.0.1:8000/api/transferenciasBancos/`, {
                        method: 'POST',
                        headers: {
                            'Authorization': `Bearer ${token}`,
                            'Content-Type': 'application/json',
        ...
        <Grid container spacing={2} columns={12} sx={{ mb: (theme) => theme.spacing(2) }}>
            ...
            <div className="div2">
                <div>
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="select-label">bancos</InputLabel>
                        <Select
                        ...
                        >
                            ...
                            <MenuItem value="bbva">BBVA Colombia</MenuItem>
                            <MenuItem value="banco-popular">Banco Popular</MenuItem>
                            <MenuItem value="banco-agrario">Banco Agrario de Colombia</MenuItem>
                            <MenuItem value="banco-av-villas">Banco AV Villas</MenuItem>
                            <MenuItem value="bancoomeva">Bancoomeva</MenuItem>
                            <MenuItem value="banco-caja-social">Banco Caja Social</MenuItem>
                            <MenuItem value="scotiabank-colpatria">Scotiabank Colpatria</MenuItem>
                            <MenuItem value="itau">Itaú Colombia</MenuItem>
                            <MenuItem value="gnb-sudameris">Banco GNB Sudameris</MenuItem>
                            <MenuItem value="citibank">Citibank Colombia</MenuItem>
                            <MenuItem value="coopcentral">Banco Cooperativo Coopcentral</MenuItem>
                            <MenuItem value="banco-w">Banco W</MenuItem>
                            <MenuItem value="serfinanza">Banco Serfinanza</MenuItem>
                            <MenuItem value="finandina">Banco Finandina</MenuItem>
                            <MenuItem value="pichincha">Banco Pichincha</MenuItem>
                        </Select>
            ...
            >
                ...
                <ModalContent>
                    ...
                    <p>Asegurate de verificar bien los datos</p>
                    <p id="modal-description" className="modal-description">

                        ¿Estás seguro de que deseas transferir $ {cantidad} a {nombre}?
