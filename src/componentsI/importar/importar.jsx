...
export default function Importar() {
    ...
    const [mensaje2, setMensaje2] = useState('El banco debe aprobar la transaccion');
    ...
    const handleSubmit = () => {
        ...
        const fetchUserData = async () => {
            ...
            if ( cantidad === "" || selectedCard === "") {console.log("tengo un basio");
                setCarga(false);
                ...
                setMensaje2('');
                try {
                    const response = await fetch(`http://127.0.0.1:8000/api/importe/`, {
                        method: 'POST',
                        headers: {
                            'Authorization': `Bearer ${token}`,
                            'Content-Type': 'application/json',
                    ...
                    if (!response.ok) {
                        ...
                        console.log('devuelve',d)
                            ...
                            setCarga(false);
                            setSuccess(true);
                            setMensaje('Importado con exito');
                            r();
            ...
            >
                ...
                <ModalContent>
                    ...
                    <p id="modal-description" className="modal-description">
                        ¿Estás seguro de que deseas Imprtar $ {cantidad}?
